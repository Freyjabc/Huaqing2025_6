...
# 数据集路径
dataset_dir = r'D:\实习\深度学习基础\dataset\Images'  # 替换为你的数据集路径
train_dir = r'D:\实习\深度学习基础\dataset\Images2\train'  # 训练集输出路径
val_dir = r'D:\实习\深度学习基础\dataset\Images2\val'  # 验证集输出路径
